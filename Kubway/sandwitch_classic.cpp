...
#include "ui_sandwitch_classic.h"

sandwitch_classic::sandwitch_classic(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::sandwitch_classic)
{
    ui->label->clear();
    btnFlag = true;
...
void sandwitch_classic::disableButtons(QPushButton* exBtn){
    for (int i = 0; i < 6; i++) {
...
void sandwitch_classic::enableButtons(){
    for (int i = 0; i < 6; i++) {
        buttons[i]->setEnabled(true);
    }
}
sandwitch_classic::~sandwitch_classic()
{
    delete ui;
}

void sandwitch_classic::on_pushButton_1_clicked()
{
    if(btnFlag) {
...
void sandwitch_classic::on_pushButton_2_clicked()
{
    if(btnFlag) {
        ui->label->setText("참치");
...
void sandwitch_classic::on_pushButton_3_clicked()
{
    if(btnFlag) {
        ui->label->setText("햄");
...
void sandwitch_classic::on_pushButton_4_clicked()
{
    if(btnFlag) {
...
void sandwitch_classic::on_pushButton_5_clicked()
{
    if(btnFlag) {
...
void sandwitch_classic::on_pushButton_6_clicked()
{
    if(btnFlag) {
...
void sandwitch_classic::on_pushButton_back_clicked()
{
    this->hide();
}

void sandwitch_classic::on_pushButton_next_clicked()
{
    b.show();
}
